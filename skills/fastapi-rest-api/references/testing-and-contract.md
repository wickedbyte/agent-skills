...
The equality test proves the *documented* shape; Schemathesis proves the *running* app honours it — it generates
...
- **Don't re-test the framework.** You don't need a test proving FastAPI parses an int path param; test *your* rules.
