...
- api-design-python-fastapi — build playbook for well-structured, fully-typed, contract-tested REST/RPC APIs in Python with
...
- api-design-go-gin — task skill for building well-structured, thoroughly tested REST/RPC HTTP APIs in idiomatic Go with Gin
  ...
  files.
- api-design-rust-axum — task skill for building well-structured, thoroughly tested REST/RPC HTTP APIs in idiomatic Rust
...
- api-design-typescript-nestjs — playbook for building well-structured, strictly-typed, thoroughly-tested REST/RPC APIs in NestJS 11 on
